...
class ShareModel extends Backbone.Model {
	...
	get defaults() {
		return {
			...
			description: 'И зачем это нужно. Рассказываем о донорстве костного мозга, чтобы увеличить российский регистр и помочь людям находить доноров. Присоединяйтесь!',
